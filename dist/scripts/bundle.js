...
var App = React.createClass({displayName: "App",
  ...
  render: function () {
    ...
    if (this.state.soldProducts.length > 0 && this.state.showShoppingCart) {
      activeComponent = React.createElement(ShoppingCart, {hideShoppingCart: this._hideShoppingCart, 
        soldproducts: this.state.soldProducts, removeproduct: this._removeProduct});
    } else if (this.state.selectedProduct === "") {
      activeComponent = React.createElement(ProductList, {items: this.state.products, buyProduct: this._buyProduct, 
        selectedProduct: this._selectedProduct});
      searchComponent = React.createElement(Search, {searchProducts: this._searchProducts});
    } else {
      activeComponent = React.createElement(ProductDetails, {hideShoppingCart: this._hideShoppingCart, 
...
module.exports = App;
},{"./components/products/productDetails":160,"./components/products/productlist":161,"./components/search/search":162,"./components/shoppingcart/shoppingCart":163,"react":157}],159:[function(require,module,exports){
'use strict';
var React = require('react');
    ...
    render: function () {
        return (
            React.createElement("div", {className: "col"}, 
                React.createElement("img", {src: this.props.item.imageurl, alt: ""}), 

                React.createElement("h5", {className: ""}, this.props.item.name), 
                React.createElement("p", {className: ""}, React.createElement("span", null, " Description: "), " ", this.props.item.description), 
                React.createElement("p", {className: ""}, React.createElement("span", null, " Price: "), " $", this.props.item.price), 
                React.createElement("p", {className: ""}, React.createElement("span", null, " Total: "), " ", this.props.item.total), 

                React.createElement("a", {href: "#", className: "btn btn-primary", onClick: this._selectedProduct}, "ViewDetails"), 

                this.props.item.total === 0 ?
                    React.createElement("a", {href: "#", className: "btn btn-danger disabled"}, "Sold out") :
                    React.createElement("a", {href: "#", className: "btn btn-success", onClick: this._buyProduct}, "Buy")
    ...
    render: function () {
        return (
            React.createElement("div", {className: "container"}, 
                ...
                React.createElement("img", {src: this.props.selectedProduct.imageurl, alt: "Card image cap"}), 
                React.createElement("div", {className: ""}, 
                    React.createElement("h5", {className: ""}, this.props.selectedProduct.name), 
                    React.createElement("p", {className: ""}, React.createElement("span", null, " Description"), " ", this.props.selectedProduct.description), 
                    React.createElement("p", {className: ""}, React.createElement("span", null, " Price"), " $", this.props.selectedProduct.price), 
                    React.createElement("p", {className: ""}, React.createElement("span", null, " Total"), " ", this.props.selectedProduct.total), 
...
var ProductsList = React.createClass({displayName: "ProductsList",
  render: function () {
    var items = this.props.items.map((item, index) => {
      return (
        React.createElement(Product, {key: index, item: item, index: index, buyProduct: this.props.buyProduct, selectedProduct: this.props.selectedProduct})
      );
    });
...
},{"./product":159,"react":157}],162:[function(require,module,exports){
'use strict';
var React = require('react');
...
var ShoppingCart = React.createClass({displayName: "ShoppingCart",
    ...
    render: function () {
        return (
            React.createElement("div", null, "This is shopping cart")
        );
    }
...
},{"./app":158,"jquery":1,"react":157}]},{},[164]);
